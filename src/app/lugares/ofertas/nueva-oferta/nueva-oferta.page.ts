...
export class NuevaOfertaPage implements OnInit {
  ...
  ngOnInit() {
    this.form = new FormGroup({
      ...
      this.lugaresService.addLugar(this.form.value.titulo, this.form.value.descripcion, +this.form.value.precio, new Date(this.form.value.desde), new Date(this.form.value.hasta));
      this.form.reset();
